...
public class ProfessorScoreVO1 {
	int sudent_s_id;
	...
	public ProfessorScoreVO1() {
		super();
		// TODO Auto-generated constructor stub
	}
	public ProfessorScoreVO1(int sudent_s_id, String sudent_s_name, String professor_p_name, int course_c_id,
	...
	public String toString() {
		return "ProfessorScoreVO [sudent_s_id=" + sudent_s_id + ", sudent_s_name=" + sudent_s_name
				+ ", professor_p_name=" + professor_p_name + ", course_c_id=" + course_c_id + ", course_c_name="
				+ course_c_name + ", p_score=" + p_score + "]";
	}
